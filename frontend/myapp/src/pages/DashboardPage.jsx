...
const StatCard = ({ label, value, sub, icon, color }) => (
  <div className="stat-card animate-fade-in">
    <div className="flex items-center justify-between mb-3">
      ...
      <div
        className={`w-10 h-10 rounded-xl ${color} flex items-center justify-center text-white text-xl`}
      >
        {icon}
      </div>
    </div>
...
const DashboardPage = () => {
  const { user, isTenant, isSuperAdmin, isOwner, refreshUser } =
    useAuth();
          ...
          <div className="space-y-6">
                ...
                <div className="space-y-4 relative z-10">
                  ...
                  {(currentPayment.status === 'pending' ||
                    ...
                    <Link
                      ...
                      className="btn-primary w-full mt-4 py-3 justify-center shadow-glow"
                    >
                      Pay Now
                    </Link>
                  )}
            ...
            <div className="card p-6">
              ...
              <p className="text-sm text-slate-400 mb-4">
                Having trouble with your room? Raise a complaint
