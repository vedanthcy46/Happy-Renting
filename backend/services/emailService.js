...
const sendRequestExpired = async (request) => {
  const html = `
    <!DOCTYPE html>
    <html>
    <head><meta charset="UTF-8"><title>Request Expired - Happy Renting</title></head>
    <body style="font-family: 'Segoe UI', Arial, sans-serif; background: #f8fafc; margin: 0; padding: 40px 20px;">
      <div style="max-width: 480px; margin: 0 auto; background: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.08);">
        <div style="background: linear-gradient(135deg, #64748b, #475569); padding: 36px 32px; text-align: center;">
          ...
          <p style="color: rgba(255,255,255,0.85); margin: 8px 0 0; font-size: 14px;">Your Owner Access Request Expired</p>
        </div>
        <div style="padding: 40px 32px; text-align: center;">
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin: 0 0 24px;">
            Hi ${request.name},<br><br>
            Your request to join Happy Renting has been pending for over 14 days and has automatically expired.
            If you still wish to use the platform, please submit a new request.
          </p>
          <a href="https://happy-renting.onrender.com" style="display: inline-block; background: #2563EB; color: #ffffff; font-weight: 600; padding: 14px 28px; text-decoration: none; border-radius: 8px; margin-bottom: 24px;">Submit New Request</a>
        </div>
  ...
  `;
  await sendEmail(request.email, 'Action Required: Your Happy Renting Request Expired', html);
};

// ── NEW: OTP Email Verification for Owner Request Form ──────────────────
const sendRequestOTPEmail = async (email, otp) => {
  const html = `
    <!DOCTYPE html>
    <html>
    <head><meta charset="UTF-8"><title>Email Verification - Happy Renting</title></head>
    <body style="font-family: 'Segoe UI', Arial, sans-serif; background: #f8fafc; margin: 0; padding: 40px 20px;">
      <div style="max-width: 480px; margin: 0 auto; background: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.08);">
        <div style="background: linear-gradient(135deg, #2563EB, #1d4ed8); padding: 36px 32px; text-align: center;">
          ...
          <p style="color: rgba(255,255,255,0.85); margin: 8px 0 0; font-size: 14px;">Happy Renting Owner Access Request</p>
        </div>
        <div style="padding: 40px 32px; text-align: center;">
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin: 0 0 28px;">Use the code below to verify your email address. This code expires in <strong>10 minutes</strong>.</p>
