...
const {
  ...
  resetUserPassword, createUserValidation, savePushToken, removePushToken, setPreferredLanguage,
...
router.delete('/profile/push-token', removePushToken); // Mobile app — logout unregister
